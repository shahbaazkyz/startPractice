...
To build the final jar and optimize the startPractice application for production, run:
...
Then navigate to [http://localhost:6080](http://localhost:6080) in your browser.
